...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.mashiro.entity.ScheduleJob scheduleJob = (com.mashiro.entity.ScheduleJob) context.getMergedJobDataMap().get(com.mashiro.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
